<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"> Data Lokasi Buku </div>
                <div class="panel-body">
                    <div class="table-responsive"> 
                        <div>
                            <a href="?page=lokasi&aksi=tambah" class="btn btn-success" style="margin-top:  8px;"><i class="fa fa-plus"></i> Tambah Lokasi Buku </a>
                        </div><br>
